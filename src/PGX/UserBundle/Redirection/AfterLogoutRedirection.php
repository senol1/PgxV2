...
class AfterLogoutRedirection implements LogoutSuccessHandlerInterface
{
    ...
    public function onLogoutSuccess(Request $request)
    {
        ...
        if (in_array('ROLE_ELEVE', $rolesTab, true)
            || in_array('ROLE_PROFESSEUR', $rolesTab, true)
            || in_array('ROLE_SURVEILLANT', $rolesTab, true)
        ...
        // Sinon on redirige vers la homepage
            ...
            $response = new RedirectResponse($this->router->generate('pgx_gestion_homepage'));
